...
const HeroSection = () => {
    return (
        ...
        overflow-hidden">
            ...
            {/*Commit */}
            <div style={{ backgroundImage: `url(${noise.src})` }} className="bg-contain z-5 h-full w-full absolute inset-0"/>
            ...
            <div className="px-[20px] tablet:px-[40px] relative z-10 w-full h-full flex flex-col gap-y-[24px] items-center justify-center">
                <div className="z-20 relative w-full flex items-center justify-center max-w-[280px] tablet:max-w-[325px] laptop:max-w-[380px] aspect-[325/203]">
                    <RiveCard/>
                </div>
