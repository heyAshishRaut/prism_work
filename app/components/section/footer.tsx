...
const Footer = () => {
    return (
        <div className={`w-full flex flex-col items-center`}>
            ...
            <div className={`pointer-events-auto px-[20px] tablet:px-[40px] w-full py-[40px] tablet:py-[50px] laptop:py-[60px] max-w-[450px] tablet:max-w-[900px] laptop:max-w-[1192px]`}>
                    ...
                    <div className={`w-full max-w-[350px] flex flex-col`}>
                        <div className={`flex flex-col items-center tablet:items-start gap-y-[40px]`}>
                            ...
                            <div className={`flex gap-x-[15px] tablet:gap-x-[20px]`}>
                                <div className={`!cursor-pointer hover:bg-white/2 h-[45px] tablet:h-[50px] w-[45px] tablet:w-[50px] flex items-center justify-center rounded-[11px] bg-white/7 border border-white/10`}>
                        ...
                        <div className={`w-full flex justify-between`}>
                            {
                                footerItems.map((e, index) => (
                                    <div key={index} className={`text-[15px] tablet:text-[16px] flex flex-col items-start gap-y-[20px]`}>
                                        ...
                                        {
                                            e.list.map((li, i) => (
                                                <a href="#" key={i} className={`cursor-pointer text-[#969696] hover:text-[#969696]/60 font-work-sans leading-[135%] tracking-[-2%]`}>{li.name}</a>
                                            ))
                                        }
                                    </div>
                                ))
